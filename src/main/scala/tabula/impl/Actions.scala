...
object DeleteTable {
  ...
  case class DeleteTableExecute[D <: DeleteTableAux](dynamoClient: DynamoDBClient) extends Execute {
    type Action = D
  ...
  implicit def deleteTableExecute[D <: DeleteTableAux](implicit dynamoClient: DynamoDBClient) = DeleteTableExecute[D](dynamoClient)
